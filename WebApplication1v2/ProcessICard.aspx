<%@ Page Title="" Language="C#" MasterPageFile="~/School.Master" AutoEventWireup="true" CodeBehind="ProcessICard.aspx.cs" Inherits="WebApplication1.ProcessICard" %>
        ...
        <div class="inner">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h2>Search Student  Record for <b>Process I Card</b> </h2>
                            ...
                            <div class="form-horizontal" id="inline-validate">
                                ...
                                <div class="form-group"> 
                                    <%--<div class="col-lg-6">
                                        ...
                                        <div class="col-lg-8">
                                            <asp:CheckBox ID="chkLKG" Text="LKG"  CssClass="checkbox-inline" runat="server" />
                                            <asp:CheckBox ID="chkUKG" Text="UKG" CssClass="checkbox-inline" runat="server" />
                                            <asp:CheckBox ID="chkI" Text="I" CssClass="checkbox-inline" runat="server" />
                                            <asp:CheckBox ID="chkII" Text="II"  CssClass="checkbox-inline" runat="server" />
                                            <asp:CheckBox ID="chkIII" Text="III" CssClass="checkbox-inline"  runat="server" />
                                            <asp:CheckBox ID="chkIV" Text="IV"  CssClass="checkbox-inline" runat="server" />
                                            <asp:CheckBox ID="chkV" Text="V"  CssClass="checkbox-inline" runat="server" />
                                             <asp:CheckBox ID="chkVI" Text="VI"  CssClass="checkbox-inline" runat="server" />
                                             <asp:CheckBox ID="chkVII" Text="VII"  CssClass="checkbox-inline" runat="server" />
                                             <asp:CheckBox ID="chkVIII" Text="VIII"  CssClass="checkbox-inline" runat="server" />
                                             <asp:CheckBox ID="chkIX" Text="IX"  CssClass="checkbox-inline" runat="server" />
                                            <asp:CheckBox ID="chkX" Text="X"  CssClass="checkbox-inline" runat="server" />
                                            <asp:CheckBox ID="chkXI" Text="XI"  CssClass="checkbox-inline" runat="server" />
                                            <asp:CheckBox ID="chkXII" Text="XII"  CssClass="checkbox-inline" runat="server" />
                                        </div>
                                    </div>--%>
                                ...
                                <div class="form-actions" style="text-align: center">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="col-lg-6">
                                            <asp:Button ID="btnPrint" CssClass="btn btn-primary btn-lg" runat="server" Text="Process Selected Icard" OnClick="btnPrint_Click" />
                                        </div>
                                        <div class="col-lg-60">
                                              <asp:Button ID="processAll" CssClass="btn btn-primary btn-lg" runat="server" Text="Process All Icard" OnClick="processAll_Click" />
                                        </div>
                                    </div>
                                </div>
                            </div>
