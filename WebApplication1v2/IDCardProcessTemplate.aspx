<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IDCardProcessTemplate.aspx.cs" Inherits="WebApplication1.IDCardProcessTemplate" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Process ID Card</title>
                    ...
                    <div class="row" ng-init="init()">
                        ...
                        <div class="col-md-4">
                            <div class="row " style="margin: 10px;">
                                ...
                                <div class="col-md-2">
                                   <%-- <button type="button" class="btn btn-default" ng-click="backToHome();">Back to Home</button>--%>
                                    <a href="ProcessICard.aspx" class="btn btn-default">Back to Process</a>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <asp:Label ID="lblschlorno" runat="server" class="btn btn-default" Text=""></asp:Label>
                                 <asp:Button runat="server" ID="next50" CssClass="btn btn-default" OnClick="next50_Click" Text="Next 50 Icard" />
                                <button type="button" class="btn btn-default" ng-click="printCards();">Process Card</button>
                                  <a href="DownloadICard.aspx" class="btn btn-default">Goto Download</a>
                            </div>
                            <div class="row">
