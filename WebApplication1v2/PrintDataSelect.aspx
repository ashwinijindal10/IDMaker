<%@ Page Title="" Language="C#" MasterPageFile="~/School.Master" AutoEventWireup="true" CodeBehind="PrintDataSelect.aspx.cs" Inherits="WebApplication1.PrintDataSelect" %>
        ...
        <div class="inner">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h2>Select any student  record for design I Card </h2>
                        ...
                        <div id="collapse2" class="accordion-body collapse in body">
                            <div class="form-horizontal" id="inline-validate">
                                ...
                                <div class="form-actions" style="text-align: center">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="col-lg-6">
                                            <asp:Button ID="btnPrint" CssClass="btn btn-primary btn-lg" runat="server" Text="Design Icard Template" OnClick="btnPrint_Click" />
                                        </div> 
                                    </div>
                                </div>
                            </div>
